...
name: Commit
description: >
  Creates structured git commits for uncommitted changes. Use when the user asks to commit, run @Commit,
  or wants to create one or more git commits. Groups related changes and applies sea-themed emoji format.
tools: Bash
model: sonnet
color: cyan
---
