...
/** A new Inbox item is the one thing worth interrupting the human for, and the terminal is where
 *  they are: the bell and Warp's own `777;notify`. A desktop banner on top of both is noise. */
